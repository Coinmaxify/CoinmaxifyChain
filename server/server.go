...
import (
	...
	"errors"
	"fmt"
	"github.com/Coinmaxify/Coinmaxify/archive"
	"github.com/Coinmaxify/Coinmaxify/blockchain"
	"github.com/Coinmaxify/Coinmaxify/chain"
	...
	"github.com/Coinmaxify/Coinmaxify/jsonrpc"
	"github.com/Coinmaxify/Coinmaxify/network"
	"github.com/Coinmaxify/Coinmaxify/secrets"
	"github.com/Coinmaxify/Coinmaxify/server/proto"
	"github.com/Coinmaxify/Coinmaxify/state"
	itrie "github.com/Coinmaxify/Coinmaxify/state/immutable-trie"
	"github.com/Coinmaxify/Coinmaxify/state/runtime"
	"github.com/Coinmaxify/Coinmaxify/state/runtime/evm"
	"github.com/Coinmaxify/Coinmaxify/state/runtime/precompiled"
...
func NewServer(config *Config) (*Server, error) {
	...
	if config.Telemetry.PrometheusAddr != nil {
		m.serverMetrics = metricProvider("Coinmaxify", config.Chain.Name, true)
		m.prometheusServer = m.startPrometheusServer(config.Telemetry.PrometheusAddr)
	} else {
		m.serverMetrics = metricProvider("Coinmaxify", config.Chain.Name, false)
	}
...
// SetupDataDir sets up the Coinmaxify data directory and sub-folders
