...
import (
	...
	"github.com/Coinmaxify/Coinmaxify/contracts/staking"
	"github.com/Coinmaxify/Coinmaxify/crypto"
	"github.com/Coinmaxify/Coinmaxify/e2e/framework"
	stakingHelper "github.com/Coinmaxify/Coinmaxify/helper/staking"
	"github.com/Coinmaxify/Coinmaxify/helper/tests"
	txpoolOp "github.com/Coinmaxify/Coinmaxify/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			...
			if i < numGenesisValidators {
				...
				dirPrefix := "Coinmaxify-non-validator-"
